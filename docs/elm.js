...
var $author$project$Cats$Loading = {$: 1};
...
var $author$project$Cats$getRandomCatGif = $elm$http$Http$get(
	{
		aw: A2($elm$http$Http$expectJson, $author$project$Cats$GotGif, $author$project$Cats$gifDecoder),
		aP: 'https://cataas.com/cat?json=true'
	});
...
var $author$project$Cats$Failure = {$: 0};
...
var $author$project$Cats$MorePlease = {$: 0};
...
var $author$project$Cats$main = $elm$browser$Browser$element(
	{aA: $author$project$Cats$init, aL: $author$project$Cats$subscriptions, aO: $author$project$Cats$update, aQ: $author$project$Cats$view});
